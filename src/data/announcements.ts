...
export const announcements: Announcement[] = [
  {
    ...
    body:
      "Following the security review in July, every employee is required to complete the Q3 Security Awareness Training. The module covers phishing recognition, secure handling of customer data, password hygiene and the updated incident reporting process.\n\nThe course takes approximately 40 minutes and can be paused at any point. Completion is tracked automatically — no confirmation email is needed. Managers will receive a compliance summary on August 24 for anyone still outstanding.",
    category: "Security",
    priority: "high",
    status: "active",
  ...
  },
  {
    ...
    body:
      "As part of the physical access upgrade, badges issued before January 2024 will stop working on August 18. Visit the front desk between 9:30 AM and 5:30 PM with your old badge and employee ID to collect a replacement.\n\nVisitor and contractor badges are handled separately by the operations team.",
    category: "Security",
    priority: "medium",
    status: "active",
    audience: "All Employees",
  ...
  },
  {
    ...
    summary:
      "Mid-year review conversations should be documented and closed out by August 29.",
    body:
      "Managers should complete mid-year performance conversations with each direct report by August 29. Use the shared conversation template and record outcomes, development goals and any support needs.\n\nHR will host two 30-minute calibration sessions in the final week of August. Escalate concerns about performance or retention risk to your HR partner before those sessions.",
    category: "HR",
    priority: "medium",
    status: "active",
    audience: "Managers",
